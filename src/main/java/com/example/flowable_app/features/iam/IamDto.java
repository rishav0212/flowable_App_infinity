...
public class IamDto {
    ...
    public static class User {
        ...
        public static class CreateRequest {
            ...
            @Schema(description = "Optional JSON metadata for the user (e.g., department, phone)", example = "{\"department\":\"Engineering\"}")
    ...
    public static class Role {
        ...
        public static class CreateRequest {
            @Schema(description = "Unique internal ID for the role (lowercase, underscores)", example = "tenant_admin")
            @NotBlank(message = "Role ID is required")
            @Pattern(regexp = "^[a-z0-9_]+$", message = "Role ID can only contain lowercase letters, numbers, and underscores")
            ...
            @Schema(description = "Detailed description of the role's purpose", example = "Full access to all tenant resources")
    ...
    public static class Resource {
        ...
        public static class CreateRequest {
            ...
            @Schema(description = "Categorization type of the resource", example = "frontend_module")
    ...
    public static class Permission {
        ...
        public static class GrantRequest {
            ...
            @Schema(description = "The allowed Action", example = "write")
